...
* En esta sección, los Product Owners pueden programar nuevas reuniones ingresando detalles como fecha, hora, participantes, plataforma, tipo de reunión y agenda. Los participantes reciben una notificación de creación de nueva renunión.
  ### Entidades: Reunion, Participante
  ### Casos de uso:
<div style="text-align: center;">
<img src=".\resources\prototipo\MGR1.png" alt="Creación 3"  style="width: 60%; height: auto;"/>
</div>
<br>

* En esta sección, se muestra todas las reuniones programadas, tanto completadas como pendientes, en una tabla con opciones de filtrado y búsqueda. Permite ver detalles, cambiar a vista de calendario y programar nuevas reuniones.
  ### Entidades: Reunion
  ### Casos de uso:
<img src=".\resources\prototipo\MGR2.png" alt="Creación 3"  style="width: 60%; height: auto;"/>
</div>
<br>

* En esta sección, se proporciona los detalles completos de una reunión seleccionada y permite su gestión. Los usuarios pueden ver, editar, cancelar la reunión y guardar cambios (para reuniones pendientes), además de generar un reporte de conformidad para **reuniones completadas**.
  ### Entidades: Reunion, Recordatorio, Participante
  ### Casos de uso:
  **Detalles para una reunión Pendiente:**
  
<img src=".\resources\prototipo\MGR3.png" alt="Creación 3"  style="width: 60%; height: auto;"/>
</div>
<br>

  **Detalles para una reunión Completada:**
  
<img src=".\resources\prototipo\MGR4.png" alt="Creación 3"  style="width: 60%; height: auto;"/>
</div>
<br>

* En esta sección, se permite crear y enviar reportes de conformidad basados en reuniones asociadas a un pedido. Incluye una lista de reuniones, resúmenes de acuerdos y una vista previa del reporte, que puede ser enviado para aprobación.
  ### Entidades: Reporte Conformidad.
  ### Casos de uso:
<img src=".\resources\prototipo\MGR5.png" alt="Creación 3"  style="width: 60%; height: auto;"/>
</div>
<br>
