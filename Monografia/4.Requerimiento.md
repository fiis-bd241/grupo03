...
| Código | R-013 |
| ------ | ----- |
 Objetivo | Asignar una nueva migración al pedido |
...
### R-024: Cancelar Reunión Programada
...
### R025: Generar Reporte de Conformidad
...
### R026: Ver Lista de Reportes de Conformidad

| **Objetivo** | Visualizar la lista de reportes de conformidad asociados a los últimos pedidos realizados. |
|:----------:|-------------------|
| **Descripción** | Describe cómo el Product Owner puede ver los reportes de conformidad para los últimos pedidos realizados, mostrando una tabla con los reportes de cada pedido hasta la fecha actual. |
| **Actor** | Product Owner, El sistema |
| **Precondición** | 1. Deben existir pedidos en el sistema con reuniones asociadas. <br> 2. Los reportes de conformidad deben estar generados y asociados a los pedidos correspondientes. |
| **Paso** | **Acción** |
| 1 | El Product Owner accede al sistema y selecciona la opción **"Lista de Reportes de Conformidad"**. |
| 2 | El sistema carga y muestra los últimos pedidos realizados. |
| 3 | El Product Owner selecciona un pedido de la lista desplegable. |
| 4 | El sistema obtiene y muestra una tabla con los reportes de conformidad asociados al pedido seleccionado, incluyendo: <br> - ID del reporte. <br> - Tipo de reporte (entrada o salida). <br> - Fecha del reporte. <br> - Estado del reporte. |
| 5 | El Product Owner revisa la tabla de reportes para el pedido seleccionado. |
| 6 | Si no hay reportes asociados al pedido, el sistema muestra un mensaje de alerta indicando que no hay reportes de conformidad disponibles para el pedido. |
| 7 | El Product Owner puede hacer clic en **"Ver Detalles"** para un reporte específico. |
| 8 | El sistema redirige al Product Owner a la vista de detalles del reporte de conformidad seleccionado. |
| 9 | Si el Product Owner desea cambiar de pedido, puede seleccionar otro pedido de la lista desplegable y repetir el proceso desde el paso 3. |
| 10 | Si no se pueden obtener los reportes de conformidad, el sistema muestra un mensaje de error indicando que no fue posible cargar los reportes. |
...
### R-033 : Agregar Concepto de Negocio
| Código | R-033 |
| ------ | ----- |
...
### R-035 : Busqueda de Equivalencias
| Código | R-035 |
| ------ | ----- |
