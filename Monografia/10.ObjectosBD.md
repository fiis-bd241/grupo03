...
#### RendimientoUsuarios
Se tiene la vista llamada RendimientoUsuarios que permite visualizar los campos de medición de los empleados en función a las tareas que completa, como tiempo promedio o calidad promedio. Es útil usar una vista ya que encapsula las consultas a las tablas para realizar los cálculos de rendimiento.
...
Al usar EXPLAIN ANALYZE en la siguiente consulta 
...
<div>
<img src="./resources/ObjetosBD/IDX-SFE1.png" alt="Sin Indice" style="width: auto; height: auto;"/>
</div>

Luego de aplicar el índice:

<div>
<img src="./resources/ObjetosBD/IDX-SFE2.png" alt="Sin Indice" style="width: auto; height: auto;"/>
</div>
