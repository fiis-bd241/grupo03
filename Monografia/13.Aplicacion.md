...
<div>
<img src=".\resources\Vistas\GE-00.jpeg" alt="V_GP_00" style="width: auto; height: auto;"/>
</div>

Si el usuario tienes los permisos necesarios, puede entrar a una serie de pantallas. En la primera podrá gestionar todos los usuarios registros en el sistema.

<div>
<img src=".\resources\Vistas\GE-01.jpeg" alt="V_GP_01" style="width: auto; height: auto;"/>
</div>

En la segunda pantalla, puede agregar a más usuarios al sistema.

<div>
<img src=".\resources\Vistas\GE-02.jpeg" alt="V_GP_01" style="width: auto; height: auto;"/>
</div>

En la tercea, puede modificar y actualizar los datos de los usuarios.

<div>
<img src=".\resources\Vistas\GE-03.jpeg" alt="V_GP_01" style="width: auto; height: auto;"/>
</div>

Y en la cuarta, se puede analizar el rendimiento de los empleados
<div>
<img src=".\resources\Vistas\GE-0e.jpeg" alt="V_GP_01" style="width: auto; height: auto;"/>
</div>


Luego que el usuario se haya registrado en el sistema, entrará la página principal donde se verán los últimos pedidos y migraciones que hicieron. Además, hay tres botones para crear reuniones, migraciones y pedidos. 
También puede hacer click al código del pedido, donde lo redirige a otra pantalla y otro botón" ver más", para ver a más detalle todos los pedidos.

<div>
<img src=".\resources\Vistas\V_GP_01.jpeg" alt="V_GP_01" style="width: auto; height: auto;"/>
</div>


Al hacer click en "ver más", se puede visualizar todos los pedidos y se puede filtrar por fechas. Igualmente, se puede hacer click en el código del pedido donde  lo redirige a otra pantalla.

<div>
<img src=".\resources\Vistas\V_GP_05.jpeg" alt="V_GP_05" style="width: auto; height: auto;"/>
</div>

Esta pantalla muestra todas las migraciones que se hicieron para ese pedido; además, se puede filtrar otras migraciones con código del pedido. Asimismo, hay un botón para agregar una migración al pedido.

<div>
<img src=".\resources\Vistas\V_GP_02.jpeg" alt="V_GP_02" style="width: auto; height: auto;"/>
</div>


Al machucar el botón, el usuario podrá hacer un formulario para agregar el pedido.

<div>
<img src=".\resources\Vistas\V_GP_03.jpeg" alt="V_GP_03" style="width: auto; height: auto;"/>
</div>

También, en la página principal, se puede agregar un pedido. Al hacer click en el botón, también nos va a dirigir a un formulario para agregar un nuevo pedido.

<div>
<img src=".\resources\Vistas\V_GP_04.jpeg" alt="V_GP_04" style="width: auto; height: auto;"/>
</div>
