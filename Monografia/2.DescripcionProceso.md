...
<img src=".\resources\FlujogramaTOBE1.png" alt="DiagramaDeFlujo" style="width: 100%; height: auto;"/>

### Proceso TO-BE

| Secuencia | Actividad                                          | Descripción         | Responsable  |
| --------- | -------------------------------------------------- | ------------------- | ------------ |
| 1         |  Revisar pedidos | Se consulta y se analiza los pedidos actuales, identificando cuáles necesitan ser atendidos o actualizados | Data Steward |
| 2        | Escoger pedido de migración | Si se identifica o se requiere una nueva migración de datos, se escogerá un pedido o, si no, se generará un nuevo pedido con los datos requeridos del usuario de origen, dependiendo del caso. | Data Steward |
| 3         | Asignar migración | Una vez seleccionado el pedido, se genera una nueva migración para los campos requeridos de las tablas que se quieren migrar. | Data Steward |
| 4         | Generar reuniones por pedido| Por cada pedido generado, se pueden solicitar diferentes reuniones para acordar ciertos acuerdos de cómo se desarrollará dicho pedido mediante reportes de conformidad. | Product Owner |
| 5        |Ver progreso de migración| Se podrá visualizar en que estado esta cada tarea relacionada a las migraciones del pedido realizado. | Data Steward |
| 6         | Ingresar concepto de negocio| Se podrá rellenar un formulario con todos los conceptos de negocio que se requieran, y luego se le podrá asociar su tabla respectiva. | Data Steward |
| 7      | Visualizar Tabla Conceptos de Negocio | Si ya se completó todos los conceptos de negocio, se podrá visualizar una tabla con todos los datos asociados a ellos. | Data Steward |
| 8     | Ingresar Equivalencias | Se podrá ingresar las equivalencias (campo y tabla equivalente) en un formulario. | Data Steward |
| 9     | Buscar equivalencias por nombre de tabla | Si ya se ingresó la equivalencia, se podrá buscar mediante el nombre de la tabla de referencia. | Data Modeler |
