...
| 5       | Ingresar Conceptos de Negocio y Equivalencias | Luego, se ingresará información de los conceptos de negocio y las equivalencias si es necesario. Si ya tiene equivalencias asociados, solo se tendrá que ir a la zona de búsqueda y seleccionar el dato buscado. | Data Steward |
| 6      | Ingresar Modelo | Posteriormente, se podrá ingresar la información del modelo o buscarlo si ya ha sido registrado. | Data Modeler |
