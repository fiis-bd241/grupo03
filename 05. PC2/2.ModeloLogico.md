...
| HoraInicio | timestamp with time zone | Momento en el que la reunión comienza. |
| Horafin | timestamp with time zone | Momento en el que la reunión termina. |
...
| estado | character varying(50) | Estado del reporte de conformidad (por ejemplo, pendiente, completado, etc.). |
...
| nombre | character varying(50) | Nombre del tipo de reunión. |
...
| Hora | timestamp with time zone | Hora del recordatorio. |
...
| Nombre | character varying(50) | Nombre del tipo de recordatorio. |
