...
INSERT INTO public."ReglaDeCarga"(
	"ID_ReglaCarga", "ID_DT", "id_tecnologia", "detalle_carga")
	VALUES (100001, , ?, "REGLA DE CARGA
SELECT A.TIPROLCLI 
...
where b.flgregeliminadofuente = 'N';"
	...
	VALUES (100002, ?, 1, "REGLA DE CARGA
Select B.DESUBIGEO
...
where a.flgregeliminado = 'N', b.flgregeliminadofuente = 'N';"
	...
	VALUES (100003, ?, 1, "REGLA DE CARGA
...
"
	...
	VALUES (100004, ?, 1, "REGLA DE CARGA
PASO 1: 
...
-- Solo se esta considerando información de consist."
	...
	VALUES (100005, ?, 1, "REGLA DE CARGA
...
where B.flgregeliminado = 'N';"
	...
	VALUES (100006, ?, 1, "REGLA DE CARGA
PASO1: 
...
on A.codclavepartycli = B.codclavepartycli"
	...
	VALUES (100007, ?, 1, "REGLA DE CARGA
...
where a.flgregeliminado = 'N',b.flgregeliminadofuente = 'N';"
	...
	VALUES (100008, ?, 1, "REGLA DE CARGA
PASO1:
...
"
	...
	VALUES (100009, ?, 1, "REGLA DE CARGA
...
where a.flgregeliminado = 'N', b.flgregeliminadofuente = 'N';"
	...
	VALUES (100010, ?, 1, "REGLA DE CARGA
PASO1:
